...
<link href="../templates/css/switcher.css" rel="stylesheet" type="text/css">
<link href="../templates/styles/BBOOTS/theme/print.css" rel="stylesheet" type="text/css" media="print" title="printonly">
...
<link href="../templates/css/bootstrap/bootstrap.css" rel="stylesheet" type="text/css">
<!-- responsive css stylesheet  -->
<link href="../templates/css/bootstrap/bootstrap-responsive.css" rel="stylesheet" type="text/css">
<!-- bootstrap.css  --><!-- Footable CSS files -->
<link href="../templates/css/footable/footable.core.css" rel="stylesheet" type="text/css">
<!-- FontAwesome CSS files --><!-- Custom Font CSS files -->
<link href="../templates/css/style.css" rel="stylesheet" type="text/css">
<link href="../templates/css/bootstrap/bootstrap-select.css" rel="stylesheet" type="text/css">
<link href="../templates/css/colors/cam.css" rel="stylesheet" id="color">
<!-- Footable CSS files --><!-- FontAwesome CSS files -->
<link href="../templates/styles/BBOOTS/theme/font-awesome/css/font-awesome.css" rel="stylesheet" type="text/css">
<link href="../templates/css/general.css" rel="stylesheet" type="text/css">
<link href="../templates/css/colors/hong.css" rel="stylesheet" id="bg">
<!-- Custom Font CSS files -->



<script src="../templates/js/head.min.js"></script>
<script type="text/javascript" src="../js/jquery.min.js"></script>

<script type="text/javascript" src="../templates/js/bootstrap/bootstrap.min.js"></script>
<script type="text/javascript" src="../templates/js/bootstrap/bootstrap-select.js"></script>
<script type="text/javascript" src="../templates/js/forum_fn.js"></script>
<script type="text/javascript" src="../templates/js/footable/footable.js"></script>
<script type="text/javascript" src="../templates/js/jquery.cookie.min.js"></script>
<script type="text/javascript" src="../templates/js/twitterFetcher_v10_min.js"></script>
<script type="text/javascript" src="../admin/templates/scripts/ckeditor/ckeditor.js"></script>
