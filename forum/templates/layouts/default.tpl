        ...
        <ul class="top-menu">
          ...
          <li class="dropdown"> <a data-toggle="dropdown" class="user-menu" id="user-menu" data-original-title="" title=""><i class="icon-globe"></i><span>Xin chào, {$login.ten} &nbsp;<span class="badge badge-info" id="tbm2" title="{if $sl_thong_bao_moi==0}Không có thông báo mới nào{else if}Có {$sl_thong_bao_moi} thông báo mới{/if}">{$sl_thong_bao_moi}</span><i class="caret"></i></span></a>
            <ul class="dropdown-menu" id="dropdown-menu">
              ...
              <li><a title="" href="/{$dien_dan.ma_linh_vuc}/{$dien_dan.domain}/thong_bao/danh_sach" ><i class="icon-inbox"></i>Thông báo mới<span class="badge badge-info" id="tbm1" style="left: 15px;" title="{if $sl_thong_bao_moi==0}Không có thông báo mới nào{else if}Có {$sl_thong_bao_moi} thông báo mới{/if}">{$sl_thong_bao_moi}</span></a></li>
              <li><a title="" href="/{$dien_dan.ma_linh_vuc}/{$dien_dan.domain}/thanh_vien/thong_tin?ma_thanh_vien={url_encode($ma_nguoi_dung)}" data-original-title=""><i class="icon-cog"></i>Thông Tin Cá Nhân</a></li>
