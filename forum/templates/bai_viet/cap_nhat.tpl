...
<main role="main">
  ...
  <form id="postform" method="post" action="cap_nhat_sm" enctype="multipart/form-data" onsubmit="return checkValidation()">
...
onload_functions.push('apply_onkeypress_event()'); 
        ...
        <fieldset>
          <div class="control-group">
          	<input type="hidden" name="data[ma]" value="{$bai_viet.ma}"/>
          ...
          <div class="controls controls-row">
            <input type="text" class="span6" placeholder="Tiêu đề bài viết" name="data[tieu_de]" id="tieu_de" maxlength="60" tabindex="2" value="{$bai_viet.tieu_de}">
          </div>
          <script src="./styles/BBOOTS/template/editor.js"></script>
          <div class="space10"></div>
          <div class="row-fluid">
            <div class="span8" style="width:100%">
              <textarea rows="10" name="data[noi_dung]" id="noi_dung" tabindex="4" onselect="storeCaret(this);" onclick="storeCaret(this);" onkeyup="storeCaret(this);" onfocus="initInsertions();" placeholder="Post it up!" class="span12 ckeditor" >{$bai_viet.noi_dung}</textarea>
            </div>
          </div>
          <div class="space10"></div>
            <div class="control-group">
           ...
           <div class="controls controls-row">
              ...
              <div class="radio">
                <input type="radio" name="data[rieng_tu]" id="khong" value="0" {if $bai_viet.rieng_tu == 0 } checked="checked" {/if} tabindex="2">
                <label for="khong">Không</label>
              </div>
              <div class="radio">
                <input type="radio" name="data[rieng_tu]" id="co" value="1" {if $bai_viet.rieng_tu == 1} checked="checked" {/if} tabindex="2">
      ...
      <div class="row-fluid">
        <fieldset class="form-actions no-margin-top">
          ...
          <button type="submit" class="btn start" data-loading-text="Chờ xử lý...<i class='icon-spin icon-spinner icon-large icon-white'></i>" accesskey="s" tabindex="6" name="post" value="Submit">Cập nhật</button>
        </fieldset>
      </div>
      <div class="space10"></div>
