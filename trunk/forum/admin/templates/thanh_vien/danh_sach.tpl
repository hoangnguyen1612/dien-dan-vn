...
&nbsp;&nbsp;&nbsp;  -->             
                 <a href="xoa.php?ma={$tv.ma_nguoi_dung}" onclick="return confirm('Bạn có chắc chắn muốn xóa {$tv.ten_thanh_vien} không ?')" title="Delete"><img style="cursor:pointer" alt="Xóa" src="/forum/admin/templates/images/icons/cross.png"> </a></td>
              </tr>      
 				{/foreach} 
