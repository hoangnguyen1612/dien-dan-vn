...
<div class="content-box-content">
  <div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
    ...
    {showMessage()}
    <form method="post" action="xu_ly_bao_cao_binh_luan_sm.php" name="fthem" onsubmit="return kiemtra()">
      <fieldset>
		<p>
        	<b>Tiêu đề bình luận</b>: <span><a target="_blank" href="/{$dien_dan.ma_linh_vuc}/{$dien_dan.domain}/bai_viet/chi_tiet?ma={$bao_cao.ma_bai_viet}">{$bao_cao.tieu_de}</a></span>
        </p>
        <p>
        	<b>Người đăng bình luận</b>: <span><a target="_blank" href="/{$dien_dan.ma_linh_vuc}/{$dien_dan.domain}/thanh_vien/thong_tin?ma_thanh_vien={url_encode($bao_cao.ma_nguoi_dang)}">{get_ho_ten($bao_cao.ma_nguoi_dang)}</a></span>
        </p>
        <p>
        	<b>Người báo cáo bình luận vi phạm</b>: <span><a target="_blank" href="/{$dien_dan.ma_linh_vuc}/{$dien_dan.domain}/thanh_vien/thong_tin?ma_thanh_vien={url_encode($bao_cao.ma_nguoi_bao_cao)}">{get_ho_ten($bao_cao.ma_nguoi_bao_cao)}</a></span>
        </p>
        <p>
        ...
        <p style="text-align:center">
          ...
          <input type="button" onclick="window.location.href='binh_luan.php'" value="Không Lưu" class="button">
        </p>
      </fieldset>
      <div class="clear"></div>
    </form>
