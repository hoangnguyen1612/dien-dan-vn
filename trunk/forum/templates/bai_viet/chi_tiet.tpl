      ...
      <article role="article" >
        <div class="well well-small " style="background-color: white;border: 5px solid #e3e3e3;">
          <div class="span3 hidden-phone" id="profile25">
            <div class="user-profile-tab">
              <div class="user-profile-avatar">
                <div class="avatar-frame"> <a href="/{$dien_dan.ma_linh_vuc}/{$dien_dan.domain}/thanh_vien/thong_tin?ma_thanh_vien={url_encode($bai_viet.ma_nguoi_dang)}" data-original-title="" title=""><img src="/home/upload/nguoi_dung/{if $bai_viet.hinh_dai_dien!=NULL}{$bai_viet.hinh_dai_dien}{else if $bai_viet.gioi_tinh==0}no_avatar_male.jpg{else if}no_avatar_female.jpg{/if}" width="100" height="100" alt="User avatar"></a> </div>
              </div>
              <div class="user-profile-row">
                <div class="user-profile-tag">Tên</div>
                <div class="user-profile-output"> <a href="/{$dien_dan.ma_linh_vuc}/{$dien_dan.domain}/thanh_vien/thong_tin?ma_thanh_vien={url_encode($bai_viet.ma_nguoi_dang)}" style="color: #AA0000;" class="username-coloured" data-original-title="" title="">{$bai_viet.ten_nguoi_dang}</a> </div>
              </div>
              <div class="user-profile-row">
          ...
          <div class="postbody span9">
            ...
            <div class="row-fluid">
              <div class="pull-left timepost"> <a href="./viewtopic.php?p=25#p25" title="" data-original-title="Post"></a> bởi &nbsp;<strong><a href="../thanh_vien/thong_tin?ma_thanh_vien={url_encode($bai_viet.ma_nguoi_dang)}" style="color: #AA0000;" class="username-coloured" data-original-title="" title="">{$bai_viet.ten_nguoi_dang}</a></strong>&nbsp; <i class="icon-time"></i> {date('h:i d-m-Y',strtotime($bai_viet.ngay_tao))} </div>
            </div>
