      ...
      <article role="article" >
        <div class="well well-small " style="background-color: white;border: 5px solid #e3e3e3;">
          ...
          <div class="postbody span9">
           ...
           <li> <span class="so_luong_thich_bai_viet">{$bai_viet.thich}</span> <a class="like btn btn-mini"><i class="icon-thumbs-up-alt thich-bai-viet"   {if $thich_bai_viet == NULL} style="color:black;font-size:1.2em;cursor:pointer"{else} style="color:crimson;font-size:1.2em;cursor:pointer"{/if}></i></a></li>
              ...
              {else}
              	<li><span class="so_luong_thich_bai_viet">{$bai_viet.thich}</span> <a class="btn btn-mini" data-original-title="Lượt thích" onclick="return false"><i class="icon-thumbs-up-alt" style="color:black;font-size:1.2em"></i></a></li>
              {/if}
            </ul>
          </div>
          {else}
