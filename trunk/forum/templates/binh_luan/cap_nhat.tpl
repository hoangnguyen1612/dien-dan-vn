<script>
	function checkValidation(){
		...
		if(tieu_de == ''){
			alert('Vui lòng nhập tiêu đề cho bình luận');
			return false;
		}
		if(noi_dung == ''){
...
onload_functions.push('apply_onkeypress_event()');
          ...
          <fieldset>
            ...
            <input type="text" class="span6" placeholder="Tiêu đề" name="data[tieu_de]" id="tieu_de" maxlength="64" tabindex="2" value="{$binh_luan.tieu_de}">
            <input type="hidden" name = "data[ma]" value="{$binh_luan.ma}"/>
            <div class="space10"></div>
            <div class="row-fluid">
              <div class="span8" style="width:100%">
                <textarea rows="10" name="data[noi_dung]" id="noi_dung" tabindex="4" onselect="storeCaret(this);" onclick="storeCaret(this);" onkeyup="storeCaret(this);" onfocus="initInsertions();" placeholder="Post it up!" class="span12 ckeditor">{$binh_luan.noi_dung}</textarea>
              </div>
            </div>
          </fieldset>
        </div>
