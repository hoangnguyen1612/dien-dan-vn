  ...
  <main role="main">
    <div class="row-fluid">
      <div class="side-segment">
        <h3>Xem thông tin cá nhân - Hung</h3>
      </div>
        ...
        <div class="well">
          <div class="row-fluid">
            <div class="span2">
              ...
              <ul class="unstyled">
                <li><span class="imageframe imageframe-glow avatar-frame"> <img src="./images/avatars/random/user13.png" width="100" height="100" title="Random avatar" alt="Random avatar"></span></li>
                <li></li>
                <li> </li>
              ...
              <div class="row-fluid">
                <div class="span7">
                  ...
                  <div class="menubar links primary">
                    <ul class="reset-list">
                      <li><i class="icon-user"></i> Tên: Hung</li>
                      <li><i class="icon-map-marker"></i> Nơi ở: TP.HCM <i class="custom-none icon-large"></i></li>
                      <li><i class="icon-gift"></i> Tuổi: 22 <i class="custom-none icon-large"></i></li>
            ...
            <div class="widget-content">
              <ul class="recent-activity">
                <li class="item"> <span class="icon red"><i class="icon16 icon-flag"></i></span>
                  ...
                  <span class="recent-detail">03-04-2014, 09:05</span> </li>
                ...
                <li class="item"> <span class="icon blue"><i class="icon16 icon-comments"></i></span> <span class="text">Tổng số bài viết: </span> <span class="recent-detail">20<strong><a href="./search.php?author_id=104&amp;sr=posts" data-original-title="" title=""></a></strong></span> </li>
