<div class="content-box-header">
	...
	<h3>Thống kê [Phản hồi chi tiết]</h3>
	<ul class="content-box-tabs">
    	<li><a href="phan_hoi.php">Phản hồi cao nhất</a></li>
...
<div class="content-box-content">
    ...
    {foreach $ds as $dien_dan}
        <div class="forum" title="Phản hồi">
            <div class="feedback"><span>{$dien_dan.feedback}%</span></div>
            <div class="content">
...
function get_data()
{
	...
	$.ajax({
		type: "POST",
		url: "/home/admin/thong_ke/get_feedback.php",
		data: {
