...
<div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
  ...
  <div id="main-content"> <!-- Main Content Section with everything -->
    ...
    <div class="clear"></div>
    <div id="footer"> <small> &#169; Copyright 2014 diendan.vn | Powered by <a href="http://themeforest.net/item/simpla-admin-flexible-user-friendly-admin-skin/46073">DIENDANVN</a> | <a href="#">Top</a> </small> </div>
    <!-- End #footer --> 
