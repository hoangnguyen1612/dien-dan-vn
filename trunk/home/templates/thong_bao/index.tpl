              ...
              <script>
                	$(document).ready(function(e) {
                        $("#da_doc").click(function(){
							$("#form").attr("action", "/home/thong_bao/da_doc.php");
							$("#form").attr("method", "post");
							$("#form").submit();
						});
                    });
                </script>
              <form action="/home/thong_bao" class="text-left" method="get" id="form">
               <!-- <label style="margin-right: 10px;">
                  <input type="checkbox" id="check-all"/>
                </label>
                <!-- Action button -->
                <!--<div class="btn-group">
                  <button type="button" class="btn dropdown-toggle" data-toggle="dropdown" style="width:100px; border-color: #ccc"> Thao tác&nbsp;&nbsp;<span class="caret"></span> </button>
                ...
                <div class="col-sm-6 search-form">
                  <div class="input-group">
                    ...
                    <div class="input-group-btn">
                      ...
                      &nbsp;&nbsp;
                      <button type="button" class="btn btn-sm btn-primary" style="width: 80px; border-radius: 3px" onClick="window.location.href='/thong_bao'">Tất cả</button>
