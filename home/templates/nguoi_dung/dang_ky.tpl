                      ...
                      <table style="width:100%">
                        <tr>
                          <td><label>Họ và Tên</label>
                            ...
                            <input class="required form-control" id="ho" style="width:50%; float:left; margin-right:1%" name="data[ho]" type="text" autofocus="autofocus" value="{$smarty.session.data.ho|default:''}" placeholder="Họ" /><input class="required form-control" id="ten" style="width:29%; float:left" name="data[ten]" type="text" autofocus="autofocus" value="{$smarty.session.data.ten|default:''}" placeholder="Tên" /></td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
                        </tr>
                        ...
                        <tr>
                          <td><label>Email</label>
                            <span class="red">*</span><br />
                            <input class="form-control" name="data[email]" type="text" id="email" value="{$smarty.session.data.email|default:''}" /></td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
                        </tr>
                        ...
                        <tr>
                          <td><label>Nhập Lại Mật Khẩu</label>
                            <span class="red">*</span><br />
                            <input class="form-control" name="data[nhap_lai_mat_khau]" type="password" id="re_mat_khau" /></td>
                        </tr>
                         <tr>
                          <td>&nbsp;</td>
                        </tr>
