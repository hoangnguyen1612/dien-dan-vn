    ...
    <div class="box-body">
        ...
        <div class="col-sm-12 custom-padding">
           {foreach $ds_moi as $dien_dan}
           	<div class="forum">
           	<center><a href="/{$dien_dan.ma_linh_vuc}/{$dien_dan.domain}"><img width="180px" src="/home/upload/dien_dan/{$dien_dan.hinh_dai_dien}" height="120px"/></a></center>
...
<div class="box" id="loading-example">
    <div class="box-header">
        ...
        <h3 class="box-title"><i class="fa fa-star fa-index"></i> {$ds_linh_vuc_1[0]['ten_linh_vuc']}</h3>
    </div><!-- /.box-header -->
    <div class="box-body">
        <div class="row">
        <div class="col-sm-12 custom-padding">
...
<div class="box" id="loading-example">
    <div class="box-header">
        ...
        <h3 class="box-title"><i class="fa fa-star fa-index"></i> {$ds_linh_vuc_2[0]['ten_linh_vuc']}</h3>
    </div><!-- /.box-header -->
    <div class="box-body">
        <div class="row">
        <div class="col-sm-12 custom-padding">
