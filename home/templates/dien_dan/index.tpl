    ...
    <div class="main">
      <div class="content"> 
		...
		<form id="forum_form" action="them_sm.php" method="post" enctype="multipart/form-data">
            ...
            <input type="text" name="ten_dien_dan" value="{$smarty.session.data.ten_dien_dan|default: ''}" placeholder="Tên diễn đàn" id="ten" style="width:70%"/>&nbsp;&nbsp;<span style="color: crimson">*</span><br />
